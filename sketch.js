...
var obstacle14, obstacle15, obstacle16, obstacle17, obstacleIM;
var speed;
var dieSound2, stagePass, deathBeep, gameComplete;
...
function preload(){
  ...
  obstacleIM = loadImage("realSpike.png")

  dieSound2 = loadSound("DieSound2.wav")
  stagePass = loadSound("StagePass.wav");
  deathBeep = loadSound("DeathBeep.wav");
...
door.shapeColor = "white";
  ...
  obstacle14 = createSprite(955,475,30,30);
  ...
  obstacle1.addImage(obstacleIM);
  obstacle2.addImage(obstacleIM);
  obstacle3.addImage(obstacleIM);
  obstacle4.addImage(obstacleIM);
  obstacle5.addImage(obstacleIM);
  obstacle6.addImage(obstacleIM);
  obstacle7.addImage(obstacleIM);
  obstacle8.addImage(obstacleIM);
  obstacle9.addImage(obstacleIM);
  obstacle10.addImage(obstacleIM);
  obstacle11.addImage(obstacleIM);
  obstacle12.addImage(obstacleIM);
  obstacle13.addImage(obstacleIM);
  obstacle14.addImage(obstacleIM);
  obstacle15.addImage(obstacleIM);
  obstacle16.addImage(obstacleIM);
  obstacle17.addImage(obstacleIM);
  ...
  obstacle10.scale = 0.08;
  obstacle11.scale = 0.08;
  obstacle12.scale = 0.08;
  obstacle13.scale = 0.08;
  obstacle14.scale = 0.08;
  obstacle15.scale = 0.08;
  obstacle16.scale = 0.08;
  obstacle17.scale = 0.08;
